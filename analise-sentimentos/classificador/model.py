...
class Model:
    def __init__(self, category_model=None):
        # Category classifier
    ...
    def predict(self, text):
        ...
        input_message = [text]
        input_message = self.category_model["vect"].transform(input_message)
        category = self.category_model["clf"].predict(input_message)[0]
